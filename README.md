...
* **Supported Algorithms:**
    * **Bubble Sort:** Visualizes the largest elements "bubbling" to the end.
...
2. **Open Project:** Launch Visual Studio and open `MFCAssignment.sln`.
3. **Configure:** Set the Solution Configuration to **Release** and Platform to **x64** for best performance.
4. **Build:** Press `Ctrl + Shift + B` to build the solution.
5. **Run:** Press `F5` to start the application.

## 📝 Usage
1. **Select Algorithm:** Use the dropdown ComboBox to choose your preferred sorting method.
2. **Start:** Click the **Start Sort** button. The text will change to "Stop Sort" to allow pausing.
3. **Reset:** Click **Reset** at any time to shuffle the bars and start fresh.
4. **Monitor:** Watch the **Progress Bar** and **Timer** to track the algorithm's completion.
